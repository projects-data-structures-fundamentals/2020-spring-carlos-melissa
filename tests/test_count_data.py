...
class TestGetColumnNames(unittest.TestCase):
    ...
    def test_for_three_entries(self):
        ...
        expected_result = {'low_salary': {'count': 1, 'min': 0, 'max': 50000, 'data': [['Argentina', 'Slightly satisfied', 'A business discipline (ex. accounting, finance, marketing)', '1 - 2 times per week', 'Secondary school (e.g. American high school, German Realschule or Gymnasium, etc.)', '1 - 2 hours', 'More than 4 years ago', 'C#;CoffeeScript;JavaScript;Ruby;HTML;CSS;Bash/Shell']]}, 'medium_salary': {'count': 0, 'min': 50001, 'max': 80000, 'data': []}, 'high_salary': {'count': 2, 'min': 80001, 'max': 200000, 'data': [

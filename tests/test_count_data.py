        ...
        expected_result = {
            ...
            'high_salary':
            {
                'count': 2, 'min': 80001, 'max': 200000, 'data': {
                    'C': 1, 'C#': 2, 'Java': 1, 'JavaScript': 2,
                    'Objective-C': 1, 'PHP': 1, 'Swift': 1, 'HTML': 2,
                    'CSS': 1, 'United Kingdom': 1, 'Moderately satisfied': 1,
                    'Computer science, computer engineering, or software ' +
                    'engineering': 1, '3 - 4 times per week': 2,
                    'Master’s degree (MA, MS, M.Eng., MBA, etc.)': 1,
                    '3 - 4 hours': 1, 'Between 1 and 2 years ago': 1,
                    'Python': 1, 'TypeScript': 1, 'Bash/Shell': 1,
                    'Germany': 1, 'Slightly dissatisfied': 1,
        ...
        expected_result = {
            'low_salary':
            {
                'count': 2, 'min': 0, 'max': 50000, 'data':
                {
                    ...
                    'Computer science, computer engineering, or software ' +
                    'engineering': 1, '3 - 4 times per week': 1,
                    'Primary/elementary school': 1, 'Less than a year ago': 1
                }
            },
            'medium_salary':
            {
                ...
                {
                    'JavaScript': 2, 'PHP': 1, 'Japan': 1,
                    'Slightly dissatisfied': 1,
                    'Information systems, information technology, or system ' +
                    'administration': 1, '3 - 4 times per week': 1,
                    'They never completed any formal education': 1,
                    '30 - 59 minutes': 1, 'Between 2 and 4 years ago': 1,
                    'Groovy': 1, 'Java': 1, 'SQL': 1, 'HTML': 1, 'CSS': 1,
                    'Bash/Shell': 1, 'Germany': 1,
                    'Moderately dissatisfied': 1,
                    'Computer science, computer engineering, or software ' +
                    'engineering': 1, "I don't typically exercise": 1,
                    'Secondary school (e.g. American high school,' +
                    ' German Realschule or Gymnasium, etc.)': 1,
            ...
            'high_salary':
            {
                ...
                {
                    'C': 1, 'C#': 3, 'Java': 2, 'JavaScript': 4,
                    'Objective-C': 1, 'PHP': 1, 'Swift': 1, 'HTML': 3,
                    'CSS': 2, 'United Kingdom': 2, 'Moderately satisfied': 2,
                    'Computer science, computer engineering, or software ' +
                    'engineering': 2, '3 - 4 times per week': 2,
                    'Master’s degree (MA, MS, M.Eng., MBA, etc.)': 3,
                    '3 - 4 hours': 1, 'Between 1 and 2 years ago': 2,
                    'Python': 3, 'TypeScript': 1, 'Bash/Shell': 1,
                    'Germany': 1, 'Slightly dissatisfied': 1,
                    'A social science (ex. anthropology, psychology, ' +
                    'political science)': 2,
                    'Secondary school (e.g. American high school,' +
                    ' German Realschule or Gymnasium, etc.)': 1,
                    '1 - 2 hours': 1, 'Between 2 and 4 years ago': 1,
                    'United States': 1, 'Moderately dissatisfied': 1,
                    '1 - 2 times per week': 2,
                    'Bachelor’s degree (BA, BS, B.Eng., etc.)': 1,
                    'Less than 30 minutes': 1, 'Go': 1, 'Ruby': 1,
                    'Extremely satisfied': 1,
                    'A humanities discipline (ex. literature, history, ' +
                    'philosophy)': 1, "I don't typically exercise": 1,
                    '30 - 59 minutes': 2, 'Less than a year ago': 2, 'SQL': 1,
                    'Netherlands': 1
                }
            }
        }

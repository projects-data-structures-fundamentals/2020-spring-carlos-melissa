        ...
        expected_result = {
            ...
            'high_salary':
            {
                'count': 2, 'min': 80001, 'max': 200000, 'data': {
                    ...
                    '3 - 4 times per week': 2, 'Master’s degree (MA, MS, M.Eng., MBA, etc.)': 1,
        ...
        expected_result = {
            ...
            'high_salary':
            {
                'count': 5, 'min': 80001, 'max': 200000, 'data':
                {
                    ...
                    '3 - 4 times per week': 2, 'Master’s degree (MA, MS, M.Eng., MBA, etc.)': 3,
                    ...
                    'Bachelor’s degree (BA, BS, B.Eng., etc.)': 1, 'Less than 30 minutes': 1,
